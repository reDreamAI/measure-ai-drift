...
Nightmare disorder affects an estimated 2--5\% of the general adult population \parencite{YPHMANIU,HM68TTLK,Q24CN9LD} and frequently co-occurs with PTSD and depression \autocite{34M7Y3F8}.
The recommended treatment, \gls{irt}, is a structured five-stage protocol in which the patient rewrites a recurring nightmare under therapist guidance \autocite{FGA5H3ZD}.
A persistent shortage of trained therapists limits the availability of IRT \autocite{7M7NHYXT}, making scalable, AI-assisted delivery a practical goal.
However, the rewriting stage requires active strategy decisions from the therapist, and an AI agent that selects different strategies on repeated runs of the same case is clinically unreliable regardless of how capable any single response may be.
