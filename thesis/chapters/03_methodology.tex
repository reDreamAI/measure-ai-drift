...
\label{sec:meth-plan}
% GROUNDING: resolves the CoT faithfulness tension from Section 2.5
%
...
%   Hybrid-thinking models (Qwen 3.5, GLM-5) run with reasoning disabled.
%
...
% Selection rationale: size class diversity, MoE vs dense architecture,
%   provider diversity, sovereignty status
