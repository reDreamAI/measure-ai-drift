...
\modelname{Gemini~3~Pro} has been validated as a reliable judge for
content validity assessment in psychology \parencite{XQDRY83T}.
The judge runs at $T = 1.0$, which is the Gemini~3 default. Google's
developer documentation warns that lowering the temperature below 1.0
can cause looping or degraded output for these models. Evaluation
consistency is ensured through the structured ternary rubric and explicit
scoring format.
