...
% Full factorial: 6 vignettes x 3 slices x 20 trials x T in {0.0, 0.7} x N models
...
\begin{table}[t]
  \centering
  \caption{Experimental conditions. Total: $6 \times 3 \times 20 \times 2 = 720$ trials per model, 4{,}320 across all models.}
...
consistency predicts response similarity. If they diverge, the clinical
...
reverse indicates different strategies producing similar surface outputs. Spearman rather
