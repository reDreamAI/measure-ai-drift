...
different outputs on each run. When the same patient presents the same
nightmare, stochastic sampling can lead to different strategy selections,
different therapeutic responses, and mismatches between declared and
executed strategies.

Each of these failure modes requires a different type of measurement. Variable
...
subsequent response. Because of this cascading effect, the
