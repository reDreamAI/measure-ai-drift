...
fixed seeds and $T = 0.0$. These lines of research share the concern for cross-run variation
but none of them ask whether a model makes the same \emph{clinical
decisions} when presented with identical patient contexts.
